const words = [
    ...
    "SABER","SABIA","SACAR","SALDO","SALIR","SALSA","SALTO","SANTO","SEGUI","SELVA",
    "SENAL","SERIO","SERIE","SIETE","SITIO","SOBRA","SOCIO","SOLAR","SONAR","SUELO",
    "SUEÑO","SUMAR","SUPER","SURCO","TABLA","TACON","TALLO","TARDE","TAREA","TECHO",
    "TELON","TEMOR","TENAZ","TENER","TENIA","TERMO","TESIS","TEXTO","TIBIO","TIGRE",
    "TILDE","TINTO","TIRAR","TITAN","TOMAR","TONTO","TORRE","TRAER","TRAMA","TRECE",
    "TRIGO","TRUCO","TURNO","UBICA","UNICO","UNION","UNTAR","USADO","USUAL","USTED",
    "VALLE","VALOR","VAPOR","VARON","VASOS","VECES","VELAR","VELAS","VENIR","VENTA",
    "VERBO","VERDE","VERSO","VIAJE","VIBRA","VIDEO","VIEJO","VIGOR","VIRAL","VIRUS",
    "VISTA","VITAL","VIVIR","VOLAR","VOTAR","VUELO","WAFER","WATTS","XENON","XILEM",
    "YACER","YATES","YERNO","YOGUR","YUNTA","ZAFRA","ZANJA","ZORRO","ZUECO"
    ];
